#include "../../../include/FFT/src/fft_furer2.h"
...
#define COMPLETE 15960757079401037823u
#define MY_MASK0 2635249153387078656u
#define MY_MASK1 5270498306774157312u
#define MY_MASK2 10540996613548314624u
#define MY_ROOT0 8502796096475496444u
#define MY_ROOT1 1397546744561501820u
#define MY_ROOT2 8572154621599633684u
#define MY_ROOT3 1540210943987252404u
#define MY_ROOT4 1441151880758558728u
#define MY_ROOT5 8546401232672553352u
#define MY_ROOT6 1371793355634421488u
#define MY_ROOT7 8403737033246802768u
#define LOG_OF_POW 3
#define MY_POW 8
#define CONST_R2 1677166609056699500u
#define CONST_R 2125699024118874111u
#define BASE_RPOW 2
#define GENERATOR 5
...
static  sfixn MontMulModSpeDEBUG_OPT3_AS_GENE(sfixn a, sfixn b){
	...
	MulHiLoUnsigned(&a, &b);
	std::cout<<a << " "<<b<<std::endl;
	q2 = b*FURER_INV_PRIME2;
	std::cout<<q2 << " "<<FURER_INV_PRIME2<<std::endl;
	MulAndAddHiLoUnsigned(&a, &b,q2,FURER_MY_PRIME2);
	std::cout<<a << " "<<b<<std::endl;
	a -= FURER_MY_PRIME2;
	std::cout<<a << " "<<b<<std::endl;
	a += (a >> BASE_1) & FURER_MY_PRIME2;
	std::cout<<a << " "<<b<<std::endl;
	return a;
}
sfixn testMontMul(usfixn u,usfixn v){
	usfixn w = MulMod(u,v>>FURER_RSFT2,FURER_MY_PRIME2);
	w = MulMod(w,FURER_RINV2,FURER_MY_PRIME2);
	return w;
}
//  64-bits code
//
...
//		"subq %%rsi,%%rdx\n\t"
//		: "=d" (a)
//		: "a"(a),"d"(b),"r"((unsigned long) FURER_INV_PRIME2),"r"((unsigned long) COMPLETE),"r"((unsigned long) FURER_MY_PRIME2)
//		:"rsi","rdi","rcx");
//	return a;
//}
...
sfixn MontMulModSpe_OPT3_AS_GENE_INLINE(sfixn a,sfixn b){
	...
	"addq %%rax,%%rdx\n\t"
	: "=d" (a)
	: "a"(a),"rm"(b),"b"((sfixn) FURER_INV_PRIME2),"c"((sfixn) FURER_MY_PRIME2)
	:"rsi","rdi");
	return a;
}
//inline sfixn MontMulModSpe_OPT3_AS_GENE_INLINE(sfixn a,sfixn b){
...
void GenRootOfUnity(sfixn e, sfixn n, sfixn * rootsPtr){
	...
	rootR=fastExp(MontMulModSpe_OPT3_AS_GENE_INLINE(GENERATOR,R_2<<BRsft),(FURER_MY_PRIME2-1)>>e);
...
void DFT_rec_p2(int n,sfixn *A,sfixn *W,sfixn *B){
	if (n==1) {    
		return;
	}
