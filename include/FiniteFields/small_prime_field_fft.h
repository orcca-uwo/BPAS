#ifndef SMALL_PRIME_FIELD_FFT_H_
#define SMALL_PRIME_FIELD_FFT_H_
...
void __inline__
mult_ab_mod_p_ptr (usfixn64 * __restrict__ a, const usfixn64 *__restrict__ b, const montgomery_triple * P)
{
...
void __inline__
DFT_2_double (usfixn64* __restrict__ a0, usfixn64*  __restrict__  a1, usfixn64*  __restrict__ a2, usfixn64*  __restrict__  a3,
...
void __inline__
DFT_32 (int n, usfixn64* __restrict__ x, const usfixn64 * __restrict__ base_case_omega_vec,
	const montgomery_triple* P)
{
...
void __inline__
DFT_64 (int n, usfixn64* __restrict__ x, const usfixn64 *__restrict__ base_case_omega_vec,
	const montgomery_triple* P)
{
  //#pragma cilk_grainsize = (SMALL_DFT_GRAIN_FACTOR*(cilk::current_worker_count))
#pragma cilk_grainsize = (n/(cilk::current_worker_count))
...
void __inline__
DFT_128 (int n, usfixn64* __restrict__ x, const usfixn64 *__restrict__ base_case_omega_vec,
	const montgomery_triple* P)
{
  //#pragma cilk_grainsize = (SMALL_DFT_GRAIN_FACTOR*(cilk::current_worker_count))
#pragma cilk_grainsize = (n/(cilk::current_worker_count))
...
void __inline__
DFT_256 (int n, usfixn64* __restrict__ x, const usfixn64 *__restrict__ base_case_omega_vec,
	const montgomery_triple* P)
{
  //#pragma cilk_grainsize = (SMALL_DFT_GRAIN_FACTOR*(cilk::current_worker_count))
#pragma cilk_grainsize = (n/(cilk::current_worker_count))
...
//cilk_
  for (int tidx = 0; tidx < (n_permutations * JK); tidx++)
//#pragma cilk_grainsize = (SMALL_PERMUTATION_GRAIN_FACTOR*(cilk::current_worker_count))
//  cilk_for(int j=0;j<JK;j++)
    {
...
//  cilk_for (int tidx=0;tidx<(n_permutations*JK);tidx++)
//  #pragma cilk_grainsize = (SMALL_PERMUTATION_GRAIN_FACTOR*(cilk::current_worker_count))
////    cilk_for(int j=0;j<JK;j++)
//      {
...
stride_permutation_small_elements (usfixn64*x, int n_permutations, int m, int n,
				   usfixn64* aux_memory)
{
  int blocksize = min_three (m, n, SMALL_FFT_OPTIMAL_PERMUTATION_BLOCKSIZE);
  int data_size = (n_permutations * m * n * sizeof(usfixn64));
  int km;
  int stride = m * n;
  ...
  for (int v_idx = 0; v_idx < n_blocks; v_idx += 1)
    {
      ...
      cilk_for (int i = 0; i < n_permutations;
	  i++
      )
	{
