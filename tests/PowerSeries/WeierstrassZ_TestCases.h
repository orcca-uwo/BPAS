#ifndef _WEIERSTRASS_Z_TESTCASES_
#define _WEIERSTRASS_Z_TESTCASES_

#include "../../include/PowerSeries/UPOPS_Z_Weierstrass.h"
 ...
 */
void TestingWeiestrassPreparation(UpopsZ_t* f, int bound, const char** sym);
